...
resource "aws_s3_bucket" "raw_bucket" {
  bucket = "mzan-raw-breweries-case"

  tags = {
    Environment = "Dev"
    Project     = "BreweryDataPipeline"
    Layer       = "Bronze"
  }
}

resource "aws_s3_bucket" "curated_bucket" {
  bucket = "mzan-curated-breweries-case"
...
resource "aws_s3_bucket" "analytics_bucket" {
  bucket = "mzan-analytics-breweries-case"
